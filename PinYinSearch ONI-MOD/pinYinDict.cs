...
namespace PinYinSearch_ONI_MOD
{
    ...
    public class pinYinDict
    {
        ...
        public static Dictionary<string, string[]> mapping()
        {
            ...
            Dict.Add("桶装水", new string[2] { "tongzhuangshui", "tzs" });
            ...
            Dict.Add("朱砂矿", new string[2] { "zhushakuang", "zsk" });
            ...
            Dict.Add("凝冻植物润滑油", new string[2] { "ningdongzhiwurunhuayou", "ndzwrhy" });
            ...
            Dict.Add("固态粘渣油", new string[2] { "gutaizhanzhayou", "gtzzy" });
            ...
            Dict.Add("粘渣油", new string[2] { "zhanzhayou", "zzy" });
            ...
            Dict.Add("植物润滑油", new string[2] { "zhiwurunhuayou", "zwrhy" });
            ...
            Dict.Add("花蜜", new string[2] { "huami", "hm" });
            ...
            Dict.Add("动物油脂", new string[2] { "dongwuyouzhi", "dwyz" });
            ...
            Dict.Add("蓄电池", new string[2] { "xudianchi", "xdc" });
            Dict.Add("巨型蓄电池", new string[2] { "juxingxudianchi", "jxxdc" });
            Dict.Add("蓄电池舱", new string[2] { "xudianchicang", "xdcc" });
            Dict.Add("智能蓄电池", new string[2] { "zhinengxudianchi", "znxdc" });
            Dict.Add("沙滩椅", new string[2] { "shatanyi", "sty" });
            Dict.Add("床铺", new string[2] { "chuangpu", "cp" });
            Dict.Add("辐射蜂巢", new string[2] { "fushefengchao", "fsfc" });
            Dict.Add("液桶排倒器", new string[2] { "yetongpaidaoqi", "ytpdq" });
            Dict.Add("气罐抽出器", new string[2] { "qiguanchouchuqi", "qgccq" });
            Dict.Add("液桶抽出器", new string[2] { "yetongchouchuqi", "ytccq" });
            Dict.Add("气罐排倒器", new string[2] { "qiguanpaidaoqi", "qgpdq" });
            Dict.Add("地堡门", new string[2] { "dipumen", "dpm" });
            Dict.Add("地堡砖", new string[2] { "dipuzhuan", "dpz" });
            Dict.Add("柴火炉", new string[2] { "chaihuolu", "chl" });
            ...
            Dict.Add("数据挖掘仪", new string[2] { "shujuwajueyi", "sjwjy" });
            Dict.Add("除污淋浴隔间", new string[2] { "chuwulinyugejian", "cwlygj" });
            Dict.Add("油炸锅", new string[2] { "youzhaguo", "yzg" });
            ...
            Dict.Add("移动电源充电机", new string[2] { "yidongdianyuanchongdianji", "yddycdj" });
            ...
            Dict.Add("气体装罐器", new string[2] { "qitizhuangguanqi", "qtzgq" });
            ...
            Dict.Add("地热热泵", new string[2] { "direrebeng", "drrb" });
            Dict.Add("地热排气口", new string[2] { "direpaiqikou", "drpqk" });
            Dict.Add("地热排气口 C-{ID}", new string[2] { "direpaiqikou C-{ID}", "drpqk C-{ID}" });
            ...
            Dict.Add("粘渣油提取器", new string[2] { "zhanzhayoutiquqi", "zzytqq" });
            ...
            Dict.Add("融冰壶", new string[2] { "rongbinghu", "rbh" });
            ...
            Dict.Add("大型放电器", new string[2] { "daxingfangdianqi", "dxfdq" });
            ...
            Dict.Add("液体装桶器", new string[2] { "yetizhuangtongqi", "ytztq" });
            ...
            Dict.Add("汞吸顶灯", new string[2] { "gongxidingdeng", "gxdd" });
            ...
            Dict.Add("火箭端口气体卸载器", new string[2] { "huojianduankouqitixiezaiqi", "hjdkqtxzq" });
            Dict.Add("火箭端口液体装载器", new string[2] { "huojianduankouyetizhuangzaiqi", "hjdkytzzq" });
            Dict.Add("火箭端口液体卸载器", new string[2] { "huojianduankouyetixiezaiqi", "hjdkytxzq" });
            Dict.Add("火箭端口固体装载器", new string[2] { "huojianduankougutizhuangzaiqi", "hjdkgtzzq" });
            Dict.Add("火箭端口固体卸载器", new string[2] { "huojianduankougutixiezaiqi", "hjdkgtxzq" });
            ...
            Dict.Add("润滑站", new string[2] { "runhuazhan", "rhz" });
            ...
            Dict.Add("氧石烛台", new string[2] { "yangshizhutai", "yszt" });
            ...
            Dict.Add("远程作业坞", new string[2] { "yuanchengzuoyewu", "yczyw" });
            Dict.Add("远程控制器", new string[2] { "yuanchengkongzhiqi", "yckzq" });
            ...
            Dict.Add("机器驾驶舱", new string[2] { "jiqijiashicang", "jqjsc" });
            ...
            Dict.Add("桑拿房", new string[2] { "sangnafang", "snf" });
            ...
            Dict.Add("袖珍放电器", new string[2] { "xiuzhenfangdianqi", "xzfdq" });
            ...
            Dict.Add("木材燃烧器", new string[2] { "mucairanshaoqi", "mcrsq" });
            Dict.Add("木雕塑块", new string[2] { "mudiaosukuai", "mdsk" });
